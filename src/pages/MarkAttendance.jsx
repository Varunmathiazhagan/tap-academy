  ...
  return (
    <DashboardLayout title="Mark Attendance" links={links}>
      ...
      >
        ...
        <motion.section
          className="rounded-3xl border border-white/10 bg-slate-900/40 p-4 sm:p-6 shadow-xl backdrop-blur-xl"
          variants={itemVariants}
        >
          <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)] lg:items-start lg:gap-8">
        ...
        <motion.section
          className={clsx(
            'relative overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/40 p-5 sm:p-8 shadow-2xl status-capsule',
        ...
        <motion.section className="grid gap-4 sm:gap-5 md:gap-6 grid-cols-1 lg:grid-cols-2" variants={itemVariants}>
          <GlassPanel
        ...
        <motion.section className="grid gap-4 sm:gap-5 md:gap-6 grid-cols-1 xl:grid-cols-5" variants={itemVariants}>
          ...
          <div className="xl:col-span-2 space-y-4">
            <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/40 px-5 py-4">
              <div>
